    ...
    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-5">
                ...
                <div class="mb-3">
                    <label for="_facebook" class="form-label">Discord</label>
                    <input type="text" class="form-control form-control-sm" name="_discord" id="_discord" value="{{ get_meta_value('_discord') }}">
                </div>
                <div class="mb-3">
                    <label for="_twitter" class="form-label">Instagram</label>
